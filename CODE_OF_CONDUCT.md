...
- Using inclusive and welcoming language in all interactions
...
This Code of Conduct applies within all community spaces including the GitHub repository, issue tracker, pull requests, discussions, and also applies when an individual is officially representing the community in public spaces.
...
*Part of the [PIQC](https://github.com/paralleliq/piqc) project.*
*Maintained by [ParalleliQ](https://paralleliq.ai)*
